...
async function main() {
  ...
  console.log("🌾 Farm: seed lots & cultivation…");
  ...
  console.log("👕 Garment manufacturing…");
  ...
  console.log("🏷  Brand receives garments & publishes passport…");
  ...
  console.log(`   Sign in with any demo account — password: ${PASSWORD}`);
  console.log(`   Public passport: /p/KAPAS-TEE-001\n`);
}
